---
name: real-estate-nz/marketing-suite
...
- `~~real-estate-nz/lead-management` - For managing interest generated by marketing.
- `~~real-estate-nz/property-analyst` - For ensuring the marketing price aligns with appraisal.
- `~~real-estate-nz/compliance-closer` - For final REA check before go-live.
