---
name: real-estate-nz/lead-management
...
- `~~real-estate-nz/marketing-suite` - For the "Rainy Day" copy adjustments.
- `~~real-estate-nz/property-analyst` - For data to back up vendor reports.
- `~~real-estate-nz/compliance-closer` - For the REA audit of the final contract.
