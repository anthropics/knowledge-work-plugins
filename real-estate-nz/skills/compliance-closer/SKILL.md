---
name: real-estate-nz/compliance-closer
...
- `~~real-estate-nz/marketing-suite` - For ensuring the Auction energy matches the ad copy.
- `~~real-estate-nz/property-analyst` - For ensuring the multi-offer prices align with market evidence.
- `~~real-estate-nz/lead-management` - For the final "Key Handover" after the deal is closed.
