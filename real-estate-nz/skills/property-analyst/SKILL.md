---
name: real-estate-nz/property-analyst
...
- `~~real-estate-nz/marketing-suite` - For translating appraisal data into ad copy.
- `~~real-estate-nz/lead-management` - For providing data to "Hot Leads."
- `~~real-estate-nz/compliance-closer` - For ensuring the final price meets REA standards.
